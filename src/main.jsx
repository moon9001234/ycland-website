...
const feeSections = [
  {
    ...
    title: "簽約手續費",
    items: [
      ["1", "簽約手續費", "2,000元", "立約人", "簽訂契約完畢給付，立約人每人各2,000元，每增加一人，加計1,000元，換約、修正契約，視異動內容幅度另行計費。"],
  ...
  },
  {
    ...
    title: "所有權移轉登記",
    items: [
      ["1", "產權移轉申報及登記", "15,000元", "權利人(買方)", "一筆土地一棟建物15,000元，每增加一筆(棟)或一人，另加計2,500元。"],
...
const resourceGroups = [
  ...
  },
  {
    title: "地方稅",
    items: [
      ["地價稅", "1.地價稅以8月31日為納稅義務基準日，於每年11月1日至11月30日止開。2.課稅期間為當年度1月1日至12月31日止。3.於8月31日前已取得土地所有權者，申請適用自用住宅用地、工業工廠用地、體育場所用地、停車場用地等特別稅率，本人或其配偶、直系親屬任一人必須在當年的9月22日（遇假日順延至第1個上班日。）以前在該地辦竣戶籍登記並申請自住用地。", "https://tytax.tycg.gov.tw/cl.aspx?n=4479"],
      ["房屋稅", "1.房屋稅以每年2月末日為納稅義務基準日，於每年5月1日起至5月31日止開徵。2.課稅期間自上一年7月1日起至當年6月30日止。3.本人、配偶或直系親屬任何一人必須在當年的3月22日(遇假日順延至第1個上班日)以前辦竣戶籍登記並申請自住房屋。", "https://tytax.tycg.gov.tw/cl.aspx?n=4461"],
      ["土地增值稅", "土地移轉時，買賣雙方應於土地買賣契約簽訂之日起30日內申報。自用住宅優惠稅率：符合條件者（如一生一次、一生一屋），可大幅降至 11% 且不計累進倍數。", "https://tytax.tycg.gov.tw/cl.aspx?n=4490", [["自用住宅優惠稅率", "https://tytax.tycg.gov.tw/cp.aspx?n=4494"]]],
  ...
  },
  {
    ...
    items: [
      ...
      ["地籍圖資網路便民服務系統", "提供以地號、建物門牌、村里等方式查詢土地位置，及區段徵收開發、市地重劃及農村社區土重劃案件、非都市土地分區及使用地類別等土地資訊查詢功能", "https://www.land.moi.gov.tw/"],
